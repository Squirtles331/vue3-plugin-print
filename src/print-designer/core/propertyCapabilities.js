...
const COMMON_FIELDS = [
  ...
  { source: "root", key: "x", type: "number", min: -1_000, max: 1_000, runtimeEffect: "position" },
  { source: "root", key: "y", type: "number", min: -1_000, max: 1_500, runtimeEffect: "position" },
  { source: "root", key: "width", type: "number", min: 0.1, max: 1_000, runtimeEffect: "size" },
  { source: "root", key: "height", type: "number", min: 0.1, max: 1_500, runtimeEffect: "size" },
  ...
  { source: "root", key: "zIndex", type: "number", min: 0, max: 9_999, runtimeEffect: "stacking" },
...
const TEXT_FIELDS = [
  { source: "root", key: "content", type: "string", maxLength: 100_000, runtimeEffect: "content" },
...
export const ELEMENT_PROPERTY_CAPABILITIES = Object.freeze({
  ...
  barcode: {
    fields: fields(COMMON_FIELDS, [
      { source: "root", key: "content", type: "string", maxLength: 4_096, runtimeEffect: "machine-code" },
