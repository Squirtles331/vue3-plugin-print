...
type PanelState = { key: PanelName; title: string; visible: boolean; x: number; y: number; width: number; height: number; defaultWidth: number; defaultHeight: number; zIndex: number };
