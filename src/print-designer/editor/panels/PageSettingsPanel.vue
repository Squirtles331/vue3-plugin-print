<template>
  <div class="page-settings-panel">
    ...
    <div class="page-settings-panel__presets">
      <button
      ...
      >
        ...
        <span>{{ option.widthMm }} × {{ option.heightMm }} mm</span>
      </button>
    </div>
