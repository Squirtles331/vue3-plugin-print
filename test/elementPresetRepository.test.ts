...
it('creates, renames, inserts, and deletes isolated element presets', async () => {
...
it('rejects duplicate names and unavailable storage without changing the editor source', async () => {
