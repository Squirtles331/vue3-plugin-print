...
it('table element renders semantic columns and preserves merged cell metadata', () => {
...
it('table element keeps bindings and resolves formatted nested values', () => {
  const object = createTableObject({
    props: {
...
it('custom blank-table preset renders as a headerless 5 by 10 grid', () => {
...
it('selected table edits only design sample data and creates an undoable command', async () => {
  const object = createTableObject({
